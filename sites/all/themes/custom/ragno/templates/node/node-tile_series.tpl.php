  ...
  <div class="node-content">
	...
	?>
  	...
  	<div class="field field-type-filefield">
		...
		<div class="field-items"><div class="filefield-item"><a href="<?php print base_path() . $nodes->field_catalog_file[0]['filepath']; ?>" target="_blank">View The Product Catalog Online</a></div></div>
  	</div> 	
  	<div class="field field-type-filefield">
