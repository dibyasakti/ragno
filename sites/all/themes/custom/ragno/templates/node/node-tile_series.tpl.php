  ...
  <div class="node-content">
  	...
  	<?php if (!empty($node->field_tech_spec)): ?>
  		<div class="field field-type-filefield field-field-tech-spec">
  			<div class="field-label"><?php print_r ($node->content['field_tech_spec']['field']['#title']); ?></div>
  			<div class="field-items"><div class="filefield-item"><div><a href="<?php print base_path() . $node->field_tech_spec[0]['filepath']; ?>" target="_blank">Click Here to Download</a></div></div></div>
  		</div>
  	<?php endif;?>   
